...
$('document').ready(function(){
		...
		$(window).resize(function(){
			 vw = $(window).width()/2;
			$('#b1,#b2,#b3,#b4,#b5,#b6,#b7,#b8,#b9,#b108').stop();
	...
	function loopTen() {
		var randleft = 1000*Math.random();
		var randtop = 500*Math.random();
		$('#b108').animate({left:randleft,bottom:randtop},10000,function(){
			loopNine();
		});
	}
	...
	$('#balloons_flying').click(function(){
		...
		$('#b2,#b3,#b6,#b8,#b108').addClass('balloons-rotate-behaviour-two');
		loopOne();
		loopTwo();
		loopThree();
		loopFour();
	...
	$('#wish_message').click(function(){
		 vw = $(window).width()/2;
		$('#b1,#b2,#b3,#b4,#b5,#b6,#b7,#8,#9,#b108').stop();
		$('#b1').attr('id','b11');
		$('#b2').attr('id','b22')
		$('#b3').attr('id','b33')
		$('#b4').attr('id','b44')
		...
		$('#b00').animate({top:240, left: vw+330},500);
